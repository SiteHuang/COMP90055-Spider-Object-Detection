...
function cmlePredict(b64img) {
    return new Promise((resolve, reject) => {
        google.auth.getApplicationDefault(function (err, authClient) {
            ...
            const params = {
                auth: authClient,
                name: 'projects/YOURBUCKET/models/YOUR_MODEL_NAME',
                resource: {
                    instances: [
                    {
                        "inputs": {
...
exports.runWhatSpiderPrediction = functions.storage.object().onFinalize((object, context) => {
